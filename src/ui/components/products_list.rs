            ...
            if products_vec.len() > available_height {
                ...
                let create_scroll_indicator = |arrows: String| -> ListItem {
                    ...
                    if arrow2_pos > arrow1_pos + 1 {
                        spans.push(Span::raw(
                            " ".repeat((arrow2_pos - arrow1_pos - 1) as usize),
                        ));
                    }
                    spans.push(Span::styled(
                        arrows.clone(),
                    ...
                    if arrow3_pos > arrow2_pos + 1 {
                        spans.push(Span::raw(
                            " ".repeat((arrow3_pos - arrow2_pos - 1) as usize),
                        ));
                    }
                    spans.push(Span::styled(
                        arrows,
                ...
                app_state.products.visible_range =
                    Some((final_scroll_offset, final_scroll_offset + content_height));
                return;
            }
        }
